...
const Body = ()=>{
    ...
    const listOfRestaurants = (0, _useRestaurantsDefault.default)();
    (0, _react.useEffect)(()=>{
        setFilteredRestaurant(listOfRestaurants);
    }, [
        listOfRestaurants
    ]);
    const RestaurantCardHighRated = (0, _restaurantCard.withHighRating)((0, _restaurantCardDefault.default));
    // Show whether a user is online or offline
    const onlineStatus = (0, _useOnlineStatusDefault.default)();
    if (onlineStatus === false) return /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("div", {
        children: [
            /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("h1", {
                children: "Errrr....You are Offline!"
            }, void 0, false, {
    ...
    return listOfRestaurants.length === 0 ? /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)((0, _shimmerDefault.default), {}, void 0, false, {
        ...
        children: [
            /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("div", {
                ...
                children: [
                    /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("div", {
                        className: "p-4 m-4 mx-2 flex gap-4",
                        children: [
                    ...
                    /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("div", {
                                className: "border border-black my-8 rounded-md ml-4 px-4       bg-[#f0f0f0] hover:bg-white",
            ...
            /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("div", {
                ...
                children: filteredRestaurant.map((restaurant)=>/*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)((0, _reactRouterDom.Link), {
                        ...
                        children: restaurant.info.avgRating >= 4.5 ? /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)(RestaurantCardHighRated, {
                            resData: restaurant
                        }, void 0, false, {
                            fileName: "src/components/Body.js",
                            lineNumber: 107,
...
_s(Body, "ZLC5lr70fJtTAU6GEouZ8Q0TGoc=", false, function() {
    return [
...
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "withHighRating", ()=>withHighRating);
var _jsxDevRuntime = require("react/jsx-dev-runtime");
var _react = require("react");
...
const RestaurantCard = (props)=>{
    ...
    // Optional Chaining
    const { cloudinaryImageId, name, locality, avgRating, cuisines, sla } = resData?.info;
...
_s(RestaurantCard, "YMrbut4/95PY8g/J6/dTj+Ex8sk=");
_c = RestaurantCard;
const withHighRating = (RestaurantCard)=>{
    return (props)=>{
        return /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("div", {
            children: [
                /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("label", {
                    className: "absolute p-2 m-2 bg-black text-white rounded-lg",
                    children: "Top Rated"
                }, void 0, false, {
                    fileName: "src/components/RestaurantCard.js",
                    lineNumber: 33,
...
},{"react/jsx-dev-runtime":"iTorj","react":"21dqq","../utils/constants":"hB8jg","../utils/UserContext":"c5vgB","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","@parcel/transformer-react-refresh-wrap/lib/helpers/helpers.js":"km3Ru"}],"3Dvwz":[function(require,module,exports) {
...
const useRestaurants = ()=>{
    ...
    const fetchData = async ()=>{
        const data = await fetch((0, _constants.RES_MENU_API));
        const json = await data.json();
        setResList(json?.data?.cards[1]?.card?.card?.gridElements?.infoWithStyle?.restaurants);
    };
    return resList;
};
_s(useRestaurants, "5vQHIpCe6jHfmvvSXtFZ8a0FNuU=");
...
},{"react":"21dqq","./constants":"hB8jg","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","@parcel/transformer-react-refresh-wrap/lib/helpers/helpers.js":"km3Ru"}]},["lv5og","1xC6H"], null, "parcelRequiread36")
